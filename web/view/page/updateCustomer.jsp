                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <!---------------------- UPDATE CUSTOMER ----------------------------->
                                            <c:set value="${updateCus}" var="ud"></c:set>
                                                
                                                <form action="updatecustomer" method="post">
                                                    <input type="hidden" name="action" value="update">
                                                    <div class="form-group">
                                                        <label >Name</label>
                                                        <input type="text" name="name"  class="form-control" value="${ud.getName()}"required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label >Phone</label>
                                                        <input type="text" name="phone"  class="form-control" value="${ud.getPhone()}" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label >Email</label>
                                                        <input type="text" name="email"  class="form-control" value="${ud.getEmail()}" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label >Address</label>
                                                        <input type="text" name="address"  class="form-control" value="${ud.getAddress()}" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <button type="submit" class="btn btn-primary mt-4 w-20" >Update Customer</button>

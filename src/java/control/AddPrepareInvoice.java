...
@WebServlet(name = "AddPrepareInvoice", urlPatterns = {"/addPrepareInvoice"})
public class AddPrepareInvoice extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            invoiceDAO.addPrepareInvoice(customerId, user.getId(), grandMoney, customerPay, 1, realTime, user.getName());

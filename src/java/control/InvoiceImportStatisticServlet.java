 ...
 * @author binh2
 */
@WebServlet(name = "InvoiceImportStatisticServlet", urlPatterns = {"/invoiceImportStatistic"})
public class InvoiceImportStatisticServlet extends HttpServlet {
...
@Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (u == null) {
            ...
            ArrayList<Orders> listOrders = dao.searchInvoicesImportWithPagination(
            ...
            request.getRequestDispatcher("/view/page/invoiceImportStatistic.jsp").forward(request, response);
        }
    }
